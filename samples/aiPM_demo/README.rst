...
This sample demonstrates exercising certain power profiles and measure the power numbers.
...
*************************
This application has a Shell CLI. It allows the following commands(power modes) from Shell CLI. All the commands that are available are for PLL based profiles.
 pm_go1
